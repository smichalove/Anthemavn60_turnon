...
Welcome to ``Anthemavn60_turnon`` contributor's guide.
...
If you experience bugs or general issues with ``Anthemavn60_turnon``, please have a look
...
You can help improve ``Anthemavn60_turnon`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Anthemavn60_turnon`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Anthemavn60_turnon``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Anthemavn60_turnon python=3 six virtualenv pytest pytest-cov
    conda activate Anthemavn60_turnon
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Anthemavn60_turnon.git
    cd Anthemavn60_turnon
...
#. Install |pre-commit|_::
   ...
   ``Anthemavn60_turnon`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Anthemavn60_turnon
.. _issue tracker: https://github.com/<USERNAME>/Anthemavn60_turnon/issues
.. <-- end -->
